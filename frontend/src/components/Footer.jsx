      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Yetbarek Temesgen</h3>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} transition={{ delay: 0.1 }}>
            <h4 className="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider mb-6">Categories</h4>
            <ul className="space-y-3">
              {['Technology', 'Lifestyle', 'Education', 'Business', 'Travel'].map((cat, idx) => (
                <motion.li key={cat} initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 * (idx + 1) }}>
                  <a
                    href={`/category/${cat.toLowerCase()}`}
                    className="text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition flex items-center group"
                  >
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} transition={{ delay: 0.2 }}>
            <h4 className="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider mb-6">Get in Touch</h4>
            <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
              <li>
                <span className="block font-medium text-gray-900 dark:text-white">Email</span>
                <a href="mailto:contact@yetbarek.com" className="hover:text-blue-600 dark:hover:text-blue-400 transition">contact@yetbarek.com</a>
              </li>
              <li>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} transition={{ delay: 0.3 }}>
            <h4 className="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider mb-6">Newsletter</h4>
        ...
        {/* Bottom Bar */}
        <motion.div className="border-t border-gray-100 dark:border-gray-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
          <p className="text-sm text-gray-500 text-center md:text-left">&copy; {currentYear} Yetbarek Temesgen. All rights reserved.</p>
          <div className="flex items-center justify-center space-x-6 mt-4 md:mt-0">
            <a href="/privacy" className="text-sm text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 transition">Privacy Policy</a>
            <a href="/terms" className="text-sm text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 transition">Terms of Service</a>
          </div>
        </motion.div>
      </div>
    </footer>
